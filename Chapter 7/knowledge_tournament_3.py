...
# save scores and players name in another file using pickle
...
name, total_score = main()
best_scores = [(name, total_score)]
print(best_scores)
f = open("best_scores.dat", "ab")
pickle.dump(best_scores, f)
f.close()

# print("Check if list is in file.")
# f = open("best_scores.dat", "rb")
# if there is smth to unpickle do it else pass
# try:
    # while True:
